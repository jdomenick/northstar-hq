...
## Context
Aggregating learning across tenants can improve models but creates real data-leakage and competitive-intel risks NorthStar Labs' audience will not tolerate.
