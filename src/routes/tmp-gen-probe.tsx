...
export const Route = createFileRoute("/tmp-gen-probe")({
...
function AssessmentGeneratorPage() {
  ...
  return <>
    <div className="print:hidden"><PageHeader eyebrow="NorthStar Labs" title="Assessment Generator" description="Enter what we know, then generate a consistent client-ready assessment." actions={<Button variant="outline" size="sm" asChild><span><ArrowLeft className="mr-2 h-4 w-4"/>Requests</span></Button>} /></div>
    <PageBody>
