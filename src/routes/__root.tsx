...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "NorthStar Labs implements business systems that produce measurable outcomes for business owners." },
      { name: "author", content: "NorthStar Labs" },
      { property: "og:title", content: "NorthStar Labs" },
      { property: "og:description", content: "NorthStar Labs implements business systems that produce measurable outcomes for business owners." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "NorthStar Labs" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "NorthStar Labs" },
      { name: "twitter:description", content: "NorthStar Labs implements business systems that produce measurable outcomes for business owners." },
