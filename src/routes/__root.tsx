...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Northstar  -  Executive Operating System" },
      { name: "description", content: "Run every venture from one place. Northstar is the executive operating system where founders think, decide, and execute." },
      { name: "author", content: "Northstar" },
      { property: "og:title", content: "Northstar  -  Executive Operating System" },
      { property: "og:description", content: "Run every venture from one place. Northstar is the executive operating system where founders think, decide, and execute." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Northstar  -  Executive Operating System" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:opsz,wght@12..96,400;12..96,500;12..96,600;12..96,700&family=Geist:wght@300;400;500;600;700&display=swap",
      },
    ],
  }),
